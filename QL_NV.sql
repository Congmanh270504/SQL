...
-- 2.1/ p.112 - CHECK CONSTRAINT
ALTER TABLE NHANVIEN
ADD CONSTRAINT CHECK_LUONG CHECK (LUONG > 0);

-- 2.2/ p.112 - UNIQUE CONSTRAINT
ALTER TABLE PHONGBAN
ADD CONSTRAINT UNI_TENPH
  UNIQUE (TENPH);

ALTER TABLE DEAN
ADD CONSTRAINT UNI_TENDA
  UNIQUE (TENDA);

-- 2.3/ p.112 - DEFAULT CONSTRAINT
ALTER TABLE THANNHAN
ADD CONSTRAINT DF_QUANHE
    DEFAULT 'Khong xac dinh' FOR QUANHE;

ALTER TABLE NHANVIEN
ADD CONSTRAINT DF_LUONG
    DEFAULT 8000000 FOR LUONG;
